 ...
 * @type TabelaHTML
 */
var tbl = new TabelaHTML("http://"+ Padrao.getHostServer() +"/CORAC/ControladorTabelas/");
/**
...
tbl.FuncoesChvExt[0] =async function(v, p, o){
           var Dados = new JSController("http://10.56.32.78:8080/CORAC/ControladorTabelas/"), result;
...
tbl.FuncoesChvExt[1] = function(v, p, o){
 ...
 * @type String
 */
tbl.setTabela = "64b99121f7e18c0f8586f30bf7806211";
