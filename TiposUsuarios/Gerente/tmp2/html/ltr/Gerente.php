...
<body>
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <span class="logo-text">
                             <!-- dark Logo text -->
                             <img src="./TiposUsuarios/Gerente/tmp2/assets/images/logo-text.png" alt="homepage" class="light-logo" />
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <!-- Search -->
                        <!-- ============================================================== -->
                        <li class="nav-item search-box"> <a class="nav-link waves-effect waves-dark"  style="display: flex !important;" href="javascript:void(0)"><i class="ti-search" style="margin: auto"></i></a>
                         ...
                         <div class="card">
                            ...
                            <div class="comment-widgets scrollable">
                                ...
                                <div class="d-flex flex-row comment-row m-t-0">
                                    <div class="p-2"><img src="./TiposUsuarios/Gerente/tmp2/assets/images/users/1.jpg" alt="user" width="50" class="rounded-circle"></div>
                                    ...
                                    <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                                        <li class="list-group-item todo-item" data-role="task">
                                            ...
                                            <ul class="list-style-none assignedto">
                                                <li class="assignee"><img class="rounded-circle" width="40" src="./TiposUsuarios/Gerente/tmp2/assets/images/users/1.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave"></li>
                                                <li class="assignee"><img class="rounded-circle" width="40" src="./TiposUsuarios/Gerente/tmp2/assets/images/users/2.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica"></li>
                                                <li class="assignee"><img class="rounded-circle" width="40" src="./TiposUsuarios/Gerente/tmp2/assets/images/users/3.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka"></li>
                                                <li class="assignee"><img class="rounded-circle" width="40" src="./TiposUsuarios/Gerente/tmp2/assets/images/users/4.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina"></li>
                                            </ul>
                                        </li>
                                        <li class="list-group-item todo-item" data-role="task">
                                            <div class="custom-control custom-checkbox">
    ...
    <script src="./TiposUsuarios/Gerente/tmp2/ltr/dist/js/jquery-ui.min.js"></script>
    ...
    <script src="./TiposUsuarios/Gerente/tmp2/assets/extra-libs/sparkline/sparkline.js"></script>
    <!--Wave Effects -->
    <script src="./TiposUsuarios/Gerente/tmp2/dist/js/waves.js"></script>
    <!--Menu sidebar -->
    <script src="./TiposUsuarios/Gerente/tmp2/dist/js/sidebarmenu.js"></script>
    <!--Custom JavaScript -->
    <script src="./TiposUsuarios/Gerente/tmp2/dist/js/custom.min.js"></script>
    <!-- this page js -->
    <script src="./TiposUsuarios/Gerente/tmp2/assets/libs/moment/min/moment.min.js"></script>
    <script src="./TiposUsuarios/Gerente/tmp2/assets/libs/fullcalendar/dist/fullcalendar.min.js"></script>
    <script src="./TiposUsuarios/Gerente/tmp2/dist/js/pages/calendar/cal-init.js"></script>
